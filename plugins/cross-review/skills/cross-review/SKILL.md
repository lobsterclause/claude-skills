...
- `kimi --plan --print --quiet` with the prompt piped via stdin — the diff (8000-line cap) followed by the whole changed files (step 2.5; `--context-mode diff` to drop them)
