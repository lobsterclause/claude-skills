...
for suite in test_json_output test_score_findings test_report_block test_digest test_snapshot test_profiles test_leaderboard_events test_fix_safety test_secret_content_scan; do
